package ipcam.circuitrocks.com.ipcam.ble;
...
import ipcam.circuitrocks.com.ipcam.R;
...
//                onConectionStateChange(mConnectionState);
                ...
                if (mSCharacteristic == mModelNumberCharacteristic) {
                    ...
                    /*if (intent.getStringExtra(BluetoothLeService.EXTRA_DATA).toUpperCase().startsWith("BLUNO"))
                    {*/
